...
echo "key create success cout " ${key_create_success_count} " goal " ${RFPLUSONE}
echo " success count " ${create_success_count} " goal " ${expected_count} " what is " $
...
echo " ******* Delete Goal " ${expected_count} " Delete count " ${delete_success_count}
...
echo " read opperations set to " ${read_operations} " ##########################################"
...
do
	...
	then
		...
		echo " read op test2 set to " ${time} "##########################################"
	...
	then
		...
		echo " read op test3 set to " ${time} "##########################################"
...
then
	...
	do
		...
		then
			...
			echo "rest test 2 count is now " ${read_test2_success_count}  " at time " ${read_op_test2_time} "#################"
...
echo " read fails are::   " ${read_fails} " ################################################ "
if [ "${read_fails}" ]
then
	while read fail
	do
		...
		then
			...
			then	
				...
				echo " test 3 part 1 count is " ${read_test3_part1_fail_count} #################################
			fi
...
echo " read test 3 part 1 count is " ${read_test3_part1_fail_count} " goal is  1 ##################################"
...
echo " test 2 outcome " ${read_test2_success_count} " goal " ${QUORUMPLUSONE}
# Display score
